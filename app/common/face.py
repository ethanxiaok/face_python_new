...
class Face:
    ...
    def face_makeup(self):
        ...
        for face_landmark in face_landmarks_list:
            ...
            # 线条
            draw.line(face_landmark['top_lip'], fill=(150, 0, 0, 64), width=2)
            draw.line(face_landmark['bottom_lip'], fill=(150, 0, 0, 64), width=2)
            # 绘制左右眼睛
            # 形状
            draw.polygon(face_landmark['left_eye'], fill=(255, 255, 255, 70))
            draw.polygon(face_landmark['right_eye'], fill=(255, 255, 255, 70))
            # 线条
    ...
    def face_68_point(self):
        ...
        model_path = os.path.join(
            ...
            ), r'static/models/shape_predictor_68_face_landmarks.dat'
        )
        # 定义预测器
